...
CGO_ENABLED=0 go build \
 -ldflags "-X github.com/openbao/openbao/version.fullVersion=2.1.0 -X github.com/openbao/openbao/version.GitCommit=93609bf0c73a18dd81ac8c7d21b95cbde1e4887c -X github.com/openbao/openbao/version.BuildDate=2024-11-29T15:34:50Z"
 .
```
